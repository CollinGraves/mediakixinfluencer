...
ActiveRecord::Schema.define(version: 20170222235122) do
  ...
  add_index "platform_accounts", ["publishing_platform_id"], name: "index_platform_accounts_on_publishing_platform_id", using: :btree
